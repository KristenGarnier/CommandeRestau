...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsRestaurant = __webpack_require__(228);

	var _componentsRestaurant2 = _interopRequireDefault(_componentsRestaurant);

	var _componentsProduit = __webpack_require__(230);

	var _componentsProduit2 = _interopRequireDefault(_componentsProduit);

	var _componentsBoisson = __webpack_require__(233);

	var _componentsBoisson2 = _interopRequireDefault(_componentsBoisson);

	var _componentsDessert = __webpack_require__(234);

	var _componentsDessert2 = _interopRequireDefault(_componentsDessert);

	var _componentsPanier = __webpack_require__(210);

	var _componentsPanier2 = _interopRequireDefault(_componentsPanier);

	var _componentsSupplement = __webpack_require__(235);

	var _componentsSupplement2 = _interopRequireDefault(_componentsSupplement);
	...
	exports['default'] = _react2['default'].createElement(
	    ...
	    _react2['default'].createElement(_reactRouter.Route, { name: 'supplement', path: '/supplement', component: _componentsSupplement2['default'] }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Panier = __webpack_require__(210);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PanierList = __webpack_require__(211);

	var _PanierList2 = _interopRequireDefault(_PanierList);

	var _PanierMenu = __webpack_require__(213);

	var _PanierMenu2 = _interopRequireDefault(_PanierMenu);

	var _utilsHelpers = __webpack_require__(214);
	...
	var Panier = _react2['default'].createClass({
	    ...
	    getInitialState: function getInitialState() {
	        ...
	        var panierSession = JSON.parse(sessionStorage.getItem('panier')),
	            panierProduits = [],
	            menu = [];
	        console.log(panierSession);
	        if (panierSession !== null) {
	            menu = panierSession[0].menu || [];
	            panierProduits = panierSession;
	            panierProduits.shift();
	        }
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(_PanierMenu2['default'], { options: this.state.panierMenu, click: this.handleDelete }),
	            _react2['default'].createElement(
	                'h3',
	                null,
	                'Vos suppléments'
	            ),
	            _react2['default'].createElement(_PanierList2['default'], { options: this.state.panierProduits, click: this.handleDeleteProd }),
	            _react2['default'].createElement(
	                'button',
	                { className: 'btn btn-default', onClick: this.handleClick },
	                'Ajouter des produits supplémentaires'
	            ),
	            this.state.panierMenu[0] || this.state.panierProduits[0] ? _react2['default'].createElement(
	                'button',
	                { className: 'btn btn-success pull-right', onClick: this.handleClickValidate },
	                'Valider le panier'
	            ) : ''
	        );
	    },
	    handleClick: function handleClick() {
	        this.history.pushState(null, '/supplement');
	    },
	    handleDelete: function handleDelete(item) {
	        ...
	        if (item[0] !== undefined) {
	            _utilsHelpers2['default'].updateSession(true);
	            this.setState({
	                panierMenu: []
	            });
	        }
	    },
	    handleDeleteProd: function handleDeleteProd(item) {
	        var res = _utilsHelpers2['default'].updateSession(false, item);
	        console.log(res);
	        this.setState({
	            panierProduits: res
	        });
	    },
	    handleClickValidate: function handleClickValidate() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ButtonSuppProd = __webpack_require__(236);

	var _ButtonSuppProd2 = _interopRequireDefault(_ButtonSuppProd);

	var PanierList = _react2['default'].createClass({
	    displayName: 'PanierList',
	        ...
	        var items = this.props.options.map(function (item, index) {
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'thumbnail' },
	                    _react2['default'].createElement('img', { src: "../uploads/" + item.image, alt: item.nom }),
	                    _react2['default'].createElement(
	                        'div',
	                        { className: 'caption' },
	                        _react2['default'].createElement(
	                        ...
	                        _react2['default'].createElement(
	                            'p',
	                            null,
	                            _react2['default'].createElement(_ButtonSuppProd2['default'], { item: item, click: _this.props.click })
	                        )
	                    )
	                )
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ButtonSupp = _react2["default"].createClass({
	    displayName: "ButtonSupp",
	    ...
	    handleNoProduct: function handleNoProduct() {
	        if (this.props.item[0]) {
	            return _react2["default"].createElement(
	                "button",
	                { className: "btn btn-danger", onClick: this.handleTo },
	                "Suprimmer"
	            );
	        }
	        return _react2["default"].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ButtonSupp = __webpack_require__(212);

	var _ButtonSupp2 = _interopRequireDefault(_ButtonSupp);

	var PanierMenu = _react2['default'].createClass({
	    displayName: 'PanierMenu',
	    ...
	    render: function render() {
	        ...
	        items = items ? items : "Vous n'avez pas encore de produits";
	        return _react2['default'].createElement(
	            'div',
	            { className: 'row' },
	            _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        ...
	                        _react2['default'].createElement(
	                            'p',
	                            null,
	                            _react2['default'].createElement(_ButtonSupp2['default'], { item: this.props.options, click: this.props.click })
	                        )
	                    )
	                )
	            )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helpers = {
	    getRestaurants: function getRestaurants() {
	        return get('http://192.168.99.100/commandes/restaurants');
	    },
	    getMenus: function getMenus(restaurant) {
	        return get('http://192.168.99.100/commandes/menus/' + restaurant);
	    },
	    getDesserts: function getDesserts(restaurant) {
	        return get('http://192.168.99.100/commandes/desserts/' + restaurant);
	    },
	    getBoissons: function getBoissons(restaurant) {
	        return get('http://192.168.99.100/commandes/boissons/' + restaurant);
	    },
	    allfromRestaurant: function allfromRestaurant(restaurant) {
	        return get('http://192.168.99.100/commandes/all/' + restaurant);
	    },
	    setSession: function setSession(key, data) {
	        var menu = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];

	        var panierSession = undefined,
	            index = undefined;
	        if (menu) {
	            if (sessionStorage.getItem(key) !== null) {
	                panierSession = JSON.parse(sessionStorage.getItem(key));
	                if (panierSession.menu !== null) {
	                    if (panierSession[0].menu.length < 3) {
	                        panierSession[0].menu.push(data);
	    ...
	    updateSession: function updateSession(menu) {
	        ...
	        if (menu) {
	            panierSession.shift();
	            if (panierSession.length < 1) {
	                sessionStorage.removeItem('panier');
	                return panierSession;
	            }
	            sessionStorage.setItem('panier', JSON.stringify(panierSession));
	            return panierSession;
	        }
	        newPanier = panierSession.filter(function (item) {
	    ...
	    setRestaurant: function setRestaurant(restaurant) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _OptionList = __webpack_require__(229);
	...
	var Restaurant = _react2['default'].createClass({
	    ...
	    componentWillMount: function componentWillMount() {
	        ...
	        _utilsHelpers2['default'].getRestaurants().then(function (data) {
	            _this.setState({
	                restaurants: data
	            });
	        });
	    ...
	    handleClick: function handleClick(e) {
	        ...
	        var res = this.state.restaurants.filter(function (item) {
	            if (item.nom === restaurants) {
	                return item;
	            }
	        });
	        _utilsHelpers2['default'].setRestaurant(res[0].id);
	        this.history.pushState(null, '/produits');
	    },

	    render: function render() {
	        console.log(this.state.restaurants);
	        var options = this.state.restaurants.map(function (option, index) {
	            return _react2['default'].createElement(
	                'option',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ItemList = __webpack_require__(231);
	...
	var Produit = _react2['default'].createClass({
	    ...
	    mixins: [Router.History],
	    getInitialState: function getInitialState() {
	        var restaurant = _utilsHelpers2['default'].getRestaurant();
	        return this.state = {
	            produits: []
	        };
	    },
	    componentWillMount: function componentWillMount() {
	        ...
	        var restaurant = _utilsHelpers2['default'].getRestaurant();
	        _utilsHelpers2['default'].getMenus(restaurant).then(function (data) {
	            _this.setState({
	                produits: data
	            });
	        });
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(_ItemList2['default'], { options: this.state.produits, click: this.handleClick })
	        );
	    }
	});
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        ...
	                        _react2['default'].createElement(
	                            'p',
	                            null,
	                            _react2['default'].createElement(_Button2['default'], { item: item, click: _this.props.click })
	                        )
	                    )
	                )
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Boisson = _react2['default'].createClass({
	    ...
	    componentWillMount: function componentWillMount() {
	        ...
	        var restaurant = _utilsHelpers2['default'].getRestaurant();
	        _utilsHelpers2['default'].getBoissons(restaurant).then(function (data) {
	            _this.setState({
	                boissons: data
	            });
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dessert = _react2['default'].createClass({
	    ...
	    componentWillMount: function componentWillMount() {
	        ...
	        var restaurant = _utilsHelpers2['default'].getRestaurant();
	        _utilsHelpers2['default'].getDesserts(restaurant).then(function (data) {
	            _this.setState({
	                desserts: data
	            });
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Supplement = _react2['default'].createClass({
	    ...
	    componentWillMount: function componentWillMount() {
	        ...
	        var restaurant = _utilsHelpers2['default'].getRestaurant();
	        _utilsHelpers2['default'].allfromRestaurant(restaurant).then(function (data) {
	            _this.setState({
	                produits: data
	            });
	        });
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                'h2',
	                null,
	                'Choisissez un produit supplémentaire'
	            ),
	            _react2['default'].createElement(_ItemList2['default'], { options: this.state.produits, click: this.handleClick })
	        );
	    }
